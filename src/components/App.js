    ...
    <div className='page'>
      <div className="page__container">
        <Routes>
          ...
          <Route path="/sign-up" element={<Register setIsRegisterTrue={setIsRegisterTrue} setIsRegisterFalse={setIsRegisterFalse} />} />
        ...
        <InfoTooltip 
          ...
          name="infoTooltip" img={ImgRegisterTrue}  
          onClose={closeAllPopups} 
          isOpen={isRegisterTrue}/>

        <InfoTooltip 
          info='Что-то пошло не так! Попробуйте ещё раз.' 
          name="infoTooltip" img={ImgRegisterFalse} 
          onClose={closeAllPopups} 
